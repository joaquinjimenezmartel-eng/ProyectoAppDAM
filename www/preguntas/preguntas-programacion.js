const preguntasProgramacion = [
    {
        ...
        "explicacion": "Una conexión con la base de datos mantiene recursos abiertos mientras se utiliza. El método `close()` del objeto `Connection` permite liberarlos cuando termina el trabajo. En aplicaciones reales es recomendable cerrarla automáticamente mediante `try-with-resources` siempre que sea posible."
    },
    {
        "id": 2,
    ...
    },
    {
        ...
        "explicacion": "Una colección dinámica puede aumentar o reducir su número de elementos durante la ejecución. A diferencia de un array, no exige fijar una capacidad invariable al declararla. Su tamaño práctico está limitado por los recursos disponibles del sistema."
    },
    {
        "id": 6,
    ...
    },
    {
        ...
        "explicacion": "Una aplicación Java ejecutable necesita un punto de entrada. La JVM comienza la ejecución en el método `public static void main(String[] args)`. El código Java se organiza en clases, pero no es obligatorio definir paquetes ni utilizar una clase con un nombre concreto."
    },
    {
        "id": 17,
    ...
    },
    {
        ...
        "explicacion": "En el contexto descrito, la opción agrupa campos que normalmente se excluyen de la persistencia. Los miembros `static` pertenecen a la clase y no al estado de cada objeto; `transient` y `@Transient` indican que un campo no debe persistirse. El tratamiento de `final` puede depender de la tecnología utilizada y no constituye por sí solo una regla universal."
    },
    {
        "id": 31,
    ...
    },
    {
        ...
        "explicacion": "El bucle `for` recorre los valores del 1 al 10 y los acumula en `resultado`, que debe haberse inicializado previamente a 0. La alternativa con `while` no incrementa el contador y la opción con `do-while` incrementa antes de sumar, por lo que no producen correctamente la suma solicitada."
    },
    {
        "id": 34,
    ...
    },
    {
      ...
      "explicacion": "La programación surgió para automatizar tareas que, realizadas manualmente, resultaban repetitivas, lentas o propensas a errores. Un programa expresa una secuencia de instrucciones que el ordenador puede ejecutar de forma rápida y consistente."
    },
    {
        "id": 51,
    ...
    },
    {
        ...
        "explicacion": "Una clase funciona como plantilla para crear objetos. A partir de ella pueden instanciarse tantos objetos como necesite la aplicación, dentro de los límites de memoria y recursos disponibles."
    },
    {
        "id": 53,
    ...
    },
    {
        ...
        "respuesta_correcta": "D. Ninguna de las anteriores es correcta.",
        "explicacion": "Un archivo WAR empaqueta los recursos necesarios para desplegar una aplicación web Java, como clases compiladas, bibliotecas, páginas JSP, HTML y archivos de configuración. Aunque utiliza internamente un contenedor basado en ZIP, su función específica es actuar como archivo de despliegue web."
      },
      {
        "id": 62,
        "pregunta": "Código traducido para que pueda ser interpretado por el microprocesador:",
...

      {
        ...
        },
        {
          ...
          "respuesta_correcta": "D. Ninguna de las anteriores.",
          "explicacion": "La definición corresponde a las palabras reservadas: términos que el lenguaje utiliza con un significado propio y que no pueden emplearse libremente como identificadores. Como esa categoría no aparece entre las opciones A, B y C, corresponde seleccionar la opción restante."
        },
        {
          "id": 78,
      ...
      },
{
  ...
  },
  {
    ...
    "explicacion": "JFreeChart es una biblioteca de código abierto para Java que permite generar gráficos de distintos tipos y personalizar su presentación. Se utiliza para incorporar visualizaciones de datos en aplicaciones Java."
  },
  {
    "id": 94,
    ...
    },
{
    ...
    "explicacion": "Los arrays de Java disponen de la propiedad `length`, que devuelve su número de elementos. También sería posible recorrerlos y contar sus posiciones, aunque `length` es la forma directa, clara y eficiente de conocer el tamaño."
  },
  {
    "id": 112,
      ...
      },
      {
        ...
        },
        {
          ...
          },
          {
            ...
            "explicacion": "GridBagLayout es un gestor de diseño utilizado habitualmente para organizar componentes de interfaces Swing. Distribuye los elementos en una cuadrícula flexible y permite controlar su posición, tamaño, separación y comportamiento al redimensionar la ventana."
          },
          {
            "id": 186,
