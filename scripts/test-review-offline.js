...
async function testOffline() {
  ...
  for (const name of ["preguntas/preguntas-sistemas-gestion-empresarial.js", "resumenes/resumen-sistemas-gestion-empresarial.js"]) assert.ok(context.self.OFFLINE_ASSETS.includes(name));
  let work;
  fail = true;
